...
import org.sonatype.nexus.plugins.foo.internal.FooFormat
import org.sonatype.nexus.plugins.foo.internal.FooRecipeSupport
    ...
    extends FooRecipeSupport
{
  ...
  @Inject
  Provider<FooProxyFacetImpl> proxyFacet
  ...
  @Inject
  FooProxyRecipe(@Named(ProxyType.NAME) final Type type,
                   @Named(FooFormat.NAME) final Format format)
  {
    super(type, format)
  }
  ...
  private ViewFacet configure(final ConfigurableViewFacet facet) {
    ...
    [packageFooMatcher(), assetFooMatcher()].each { matcher ->
